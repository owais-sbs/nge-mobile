...
const PostDetailScreen = (): React.JSX.Element => {
  ...
  const loadComments = async () => {
    ...
    try {
      ...
      if (response.IsSuccess && response.Data) {
        console.log(
          "Comments data with User profile images:",
          JSON.stringify(
            response.Data.map((c) => ({
              id: c.Id,
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={styles.postCard}>
            <View style={styles.postHeader}>
              <Image
                source={
                  isValidProfileImage(post.ProfileImage)
            ...
            <View style={styles.postActions}>
              ...
              >
                ...
                <Text
                  style={[styles.actionText, saved && { color: "#F5B400" }]}
                >
                  {saved ? "Saved" : "Save"}
                </Text>
              </TouchableOpacity>
                ...
                <View key={comment.Id} style={styles.commentItem}>
                  <View style={styles.commentHeader}>
                    <View style={styles.commentHeaderLeft}>
                      <Image
                        source={
                          isValidProfileImage(comment.User?.ProfileImage)
      ...
      <Modal visible={showDeleteLoader} transparent animationType="fade">
